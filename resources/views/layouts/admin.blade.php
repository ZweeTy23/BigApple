            ...
            <div class="flex items-center gap-3">
                ...
                @auth
                    @if(Auth::user()->isSuperAdmin())
                        <span class="hidden sm:inline-block bg-[#C21818]/10 text-[#C21818] border border-[#C21818]/25 text-[10px] font-black px-3 py-1 rounded-full uppercase">
                            👑 Super Admin (Control Total)
                        </span>
                    @else
                        <span class="hidden sm:inline-block bg-[#17A085]/10 text-[#17A085] border border-[#17A085]/30 text-[10px] font-black px-3 py-1 rounded-full uppercase">
